...
If you want to add documentation for a new stack, see our [stack template](#) or create an issue in the [GitHub repository](https://github.com/razd-cli/docs).
