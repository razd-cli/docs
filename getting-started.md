...
### Сценарий 3: Мастер-класс/Туториал

```bash
# Инструктор делится ссылкой
razd up https://github.com/workshop/react-basics

# Все участники получают идентичное окружение за секунды
```
...
1. 📖 **Изучите полное [Руководство](/guide/)** — узнайте больше о возможностях Razd
2. ❓ **Ознакомьтесь с [FAQ](/faq)** — ответы на частые вопросы
...
4. 🔧 **Изучите продвинутые возможности**:
   - Сложные конфигурации инструментов с переменными окружения
   - Композиция задач и зависимости
   - Интеграция с CI/CD
   - Мульти-проектные workspace
