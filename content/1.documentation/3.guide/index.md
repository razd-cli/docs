...
:::tip Документация по стекам
Для подробных руководств по конкретным технологиям см. [документацию по стекам технологий](/stack/)
:::
...
::: details Подробное руководство по установке
...
Секция `tasks` в `Razdfile.yml` основана на стандарте [Taskfile.yml](https://taskfile.dev/). Полную документацию по синтаксису и возможностям задач смотрите в [официальном руководстве Taskfile](https://taskfile.dev/docs/guide).
...
2. 💡 **Посмотрите [примеры проектов](https://github.com/razd-cli/razd/tree/main/examples)** — реальные конфигурации
